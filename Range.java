import java.util.*;
public class Range{
  ArrayList<String> inner16;
  ArrayList<String> inner15;
  ArrayList<String> inner14;
  ArrayList<String> inner13;
  ArrayList<String> inner12;
  ArrayList<String> inner11;
  ArrayList<String> inner10;
  ArrayList<String> inner9;
  ArrayList<String> inner8;
  ArrayList<String> inner7;
  ArrayList<String> inner6;
  ArrayList<String> inner5;
  ArrayList<String> inner4;
  ArrayList<String> inner3;
  ArrayList<String> inner2;
  ArrayList<String> inner1;
  ArrayList<ArrayList<String>> attributeRange;

public Range(){
   attributeRange = new ArrayList<ArrayList<String>>();


   inner2 = new ArrayList<String>();
  inner2.add("age");
  inner2.add("continuous");
  attributeRange.add(inner2);

   inner3 = new ArrayList<String>();
  ...
  attributeRange.add(inner5);
   ...
   inner6 = new ArrayList<String>();
  inner6.add("education-num");   //education-num: continuous.
  inner6.add("continuous");
  attributeRange.add(inner6);

   inner7 = new ArrayList<String>();
  ...
  attributeRange.add(inner7);


   inner8 = new ArrayList<String>();
